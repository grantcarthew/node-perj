module.exports = {
  ...
  dataSmall: this.tardis,
  dataLarge: this.deathStar,
  dataMedium: this.serenity,
  rndMsg () {
    return this.msg[Math.floor(Math.random() * Math.floor(this.msg.length - 1))]
  },
  rndData () {
    return this.data[Math.floor(Math.random() * Math.floor(this.data.length - 1))]
  }
}
