...
describe('serialize error tests', () => {
  test('default serialize empty error test', () => {
    ...
    expect(Object.keys(tool.objOut.data).length).toBe(1)
  ...
  test('default serialize standard error test', () => {
    ...
    expect(Object.keys(tool.jsonOut.data).length).toBe(2)
    expect(Object.keys(tool.objOut.data).length).toBe(2)
  ...
  test('default serialize multiple standard error test', () => {
    ...
    expect(Object.keys(tool.jsonOut.data[0]).length).toBe(2)
    expect(Object.keys(tool.objOut.data[0]).length).toBe(2)
    ...
    expect(Object.keys(tool.jsonOut.data[1]).length).toBe(2)
    expect(Object.keys(tool.objOut.data[1]).length).toBe(2)
  ...
  test('default serialize extended error test', () => {
    ...
    expect(Object.keys(tool.jsonOut.data.innerException).length).toBe(3)
    expect(Object.keys(tool.objOut.data.innerException).length).toBe(3)
